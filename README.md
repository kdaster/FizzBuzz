...
What is the last string that the program will print? Buzz
...
- instead of def, we use public static void main()
- instead of string, String[] args is used
- && is used instead of and
- instead of print(), System.out.println()
- i++ is used instead of i += 1
